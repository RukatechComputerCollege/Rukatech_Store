...
const ShoppingCart = () => {
  ...
  const handleWhatsAppOrder = async () => {
    try {
      ...
      console.log("Calling endpoint: ", `${API_URL}/user/order/order-whatsapp`);
              ...
              <aside className="lg:col-span-4 space-y-[24px] sticky top-[100px]">
                ...
                <div className="space-y-[12px]">
                  ...
                  <button
                    ...
                    className="w-full bg-[#25D366] text-white font-inter text-[24px] py-4 rounded-full shadow-[16px] hover:brightness-95 transition-all active:scale-[0.98] flex items-center justify-center gap-[16px] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <svg
