    ...
    <div style={{padding: '40px 0px 100px 40px'}} className='w-[250px] h-full sticky top-0 bg-[#1E2753] flex flex-col justify-start items-center overflow-x-hidden overflow-y-auto'>
      <div className='w-full text-white flex flex-col gap-[1.3em] h-full'>
        <div className='w-full flex flex-col'>
          ...
          <div className='w-full '>
            <NavLink style={{padding: '10px'}} to='flash-sales' className={({ isActive }) => `w-full flex items-center gap-2 px-4 py-2 rounded-l-md transition-all duration-300 ${ isActive ? 'bg-[#F5F6FA] text-[#7E84A3] shadow-md scale-[1.03]' : 'text-white hover:bg-[#2d3864]' }`}>
             <LiaRibbonSolid size={24} />
             <span className='text-[14px]'>Flash Sales</span>
            </NavLink>
          </div>
          {/* for categories */}
          {/* <div className='w-full '>
          ...
          {/* for reviews */}
          <div className='w-full '>
            <NavLink style={{padding: '10px'}} to='reviews' className={({ isActive }) => `w-full flex items-center gap-2 px-4 py-2 rounded-l-md transition-all duration-300 ${isActive ? 'bg-[#F5F6FA] text-[#7E84A3] shadow-md scale-[1.03]' : 'text-white hover:bg-[#2d3864]'}`}>
             <FaRegStar size={24} />
             <span className='text-[14px]'>Reviews</span>
            </NavLink>
          </div>
          {/* for reports */}
          {/* <div className='w-full '>
