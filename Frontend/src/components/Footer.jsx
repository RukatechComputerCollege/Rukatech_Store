  ...
  return (
    <footer className="w-full mt-12 bg-[#313133] border-t border-gray-700">
      ...
      <div className="bg-[#313133] border-b border-gray-700 py-8">
        <div className="max-w-296 mx-auto px-2 md:px-4 flex flex-col md:flex-row md:items-center justify-between gap-12">
          ...
          <div className="flex gap-2">
            <input
              className="bg-white rounded border-none px-4 py-3 text-sm"
              placeholder="Enter E-mail Address"
              type="email"
            />
            <button className="bg-[#f68b1e] text-white px-4 md:px-8 py-3 rounded font-bold hover:bg-[#e07b1a] transition-colors uppercase text-sm">
              Subscribe
            </button>
          </div>
        </div>
      ...
      {/* <!-- Main Footer Links --> */}
      <div className="w-full py-10 px-4 md:px-20 grid grid-cols-1 md:grid-cols-4 gap-8 max-w-296 mx-auto">
        <div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            {allCategory &&
              allCategory.slice(0, 6).map((cat, index) => (
                <li
                  className="text-gray-400 text-xs hover:text-white transition-colors"
                  key={index}
                >
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            <li
              className="cursor-pointer text-gray-400 text-xs hover:text-white transition-colors"
              onClick={() => navigate("/store")}
            >
              Shop Product
            </li>
        ...
        <div className="flex flex-col">
          <h4 className="text-white text-center md:text-left font-bold text-sm mb-4 uppercase">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <ul className="flex flex-col gap-2">
              <li className="md:hidden text-gray-400 text-xs hover:text-white transition-colors">
                United State of America
              </li>
              <li className="hidden md:block text-gray-400 text-xs hover:text-white transition-colors">
                USA
              </li>
            </ul>
          </div>
      ...
      {/* <!-- Social & App Download --> */}
      <div className="max-w-296 mx-auto px-4 py-8 border-t border-gray-700 flex flex-col md:flex-row md:items-center justify-between">
