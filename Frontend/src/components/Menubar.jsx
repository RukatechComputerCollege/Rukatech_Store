...
const Menubar = ({ closeMenu }) => {
  ...
  return (
    <>
      ...
      {/* Drawer content */}
      <div
        className="w-4/5 sm:w-2/3 fixed top-0 left-0 h-screen overflow-y-auto z-1000 bg-white text-[#191C1F] shadow-2xl border-r border-gray-200 flex flex-col"
      ...
      >
        ...
        <div className="w-full flex items-center justify-between border-b border-gray-100 pb-4 mb-4 shrink-0">
          <div className="flex items-center gap-2 cursor-pointer">
            ...
            <h1 className="logoTxt text-primary text-[18px] font-bold">
              RukatechStore
            </h1>
          </div>
          <IoMdClose
            className="cursor-pointer text-[#191C1F] hover:text-red-500 transition-colors"
            onClick={closeMenu}
            size={24}
          />
        </div>
        ...
        <div className="flex flex-col gap-1 mb-6">
          <h2 className="px-2 uppercase font-bold text-xs text-primary mb-2 tracking-wider">
            Categories
          </h2>
          <a
            href="/store"
        ...
        <div className="bg-gray-50 rounded-xl p-4 flex flex-col gap-4 mb-6 border border-gray-100">
          ...
          >
            ...
            <div>
              <p className="text-[10px] font-bold uppercase text-gray-800 group-hover:text-primary-light transition-colors">
                CHAT US
              </p>
              <p className="text-[9px] text-gray-500 font-medium">
