  ...
  return (
    <div className='w-full h-full bg-[#ffd8bddd] backdrop-blur-lg'>
        <div className='w-full h-full flex flex-col items-center justify-center'>
            ...
            <div
                className="absolute inset-0 rounded-xl bg-[#fa823256] blur-xl animate-pulse"
            ></div>

            <div className="w-full h-full relative flex items-center justify-center">
                <div
                className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#2DA5F3] via-[#FA8232] to-[green] animate-spin blur-sm"
                ></div>

                <div
                className="absolute inset-1 bg-[#FFE7D6] rounded-lg flex items-center justify-center overflow-hidden"
                >
                <div className="flex gap-1 items-center">
                    <div
                    className="w-1.5 h-12 bg-[#2DB224] rounded-full animate-[bounce_1s_ease-in-out_infinite]"
                    ></div>
                    <div
                    className="w-1.5 h-12 bg-blue-500 rounded-full animate-[bounce_1s_ease-in-out_infinite_0.1s]"
                    ></div>
                    <div
                    className="w-1.5 h-12 bg-[#FA8232] rounded-full animate-[bounce_1s_ease-in-out_infinite_0.2s]"
                    ></div>
                    <div
